    ...
    <>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <div className='p-5 text-center '>
            <h1 className='mb-4 text-xl font-bold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-2xl dark:text-white'>Ajouter un nouveau chercheur</h1>
            </div>
            <h2 className='text-1xl font-bold dark:text-white text-center'>les informations personnelles</h2>
      ...
      <FormField
          ...
          />
            ...
            <h2 className='text-1xl font-bold dark:text-white text-center'>les informations professionnelles</h2>
            <hr className='h-px my-8 bg-black  bg-opacity-50 border-0 '></hr>
            <FormField
            control={form.control}
              ...
              <FormItem>
                ...
                <div className='pl-6'>
                 ...
                 <SelectItem value="directeur de recherche">Directeur de recherche</SelectItem>
                        <SelectItem value="maitre de recherche">Maitre de recherche</SelectItem>
                        <SelectItem value="charge de recherche">Charge de recherche</SelectItem>
                        <SelectItem value="attache de recherche">Attache de recherche</SelectItem>
                        <SelectItem value="null">NULL</SelectItem>
                </SelectContent>
                </div>
                </Select>

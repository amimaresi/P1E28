  ...
  return (<div>
    <div className=' pt-16 flex items-center justify-center m-[5vw]'>
      <div className='flex flex-row justify-between items-center rounded-2xl bg-white h-[25vw] md:h-[20vw] w-[70vw] md:w-[65vw] p-[1vw] shadow-md'>
        ...
        <div className='flex flex-col w-[27vw] md:w-[20vw] h-[20vw] md:h-[17vw] items-start gap-1 md:gap-3'>
          ...
          <p className='text-[1.6vw] font-semibold md:font-medium md:text-[1.3vw] w-[25vw] md:w-auto font-text m-0 '>{boxes[index].paragraphe}</p>
        </div>

        <img src={boxes[index].img} alt="background" className=' mr-2 h-[20vw] md:h-[17vw] w-[25vw] md:w-[30vw] object-cover object-center rounded-xl' />
